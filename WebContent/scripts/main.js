/*step 1, set up anonymous function*/
(function() {
/*step 2. set up */
  /**
   * Variables
...
/*step 8. define initGeolocation*/
  function initGeoLocation() {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
    		  /*step 8.1 onPsitionUpdated function*/
        onPositionUpdated,
...
/*Step 3, create helper function*/
   ...
   */
  /*step 10. define loadNearbyItms function*/
   ...
   */
  /*step16: define changefavoriteItem function*/
  ...
  /*step12. define listItems function*/
   ...
   */
  /*step14: define addItem function*/
  function addItem(itemList, item) {
    ...
    favLink.onclick = function() {
    	/*step15: changeFavoriteItem function*/
